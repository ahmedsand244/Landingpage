...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Load featured projects for the hero/overview section with prefetched gallery and technologies
        context['featured_projects'] = Project.objects.filter(is_featured=True).prefetch_related('gallery', 'technologies')[:3]
